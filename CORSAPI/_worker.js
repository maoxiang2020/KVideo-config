...
const JSON_SOURCES = {
  'lite': {
    name: '健康过滤版 (normal)',
    url: 'https://raw.githubusercontent.com/maoxiang2020/KVideo-config/main/lite.json'
  },
  'adult': {
    name: '完整过滤版 (normal+premium)',
    url: 'https://raw.githubusercontent.com/maoxiang2020/KVideo-config/main/adult.json'
  },
  'full': {
    name: '完整版 (Full)',
    url: 'https://raw.githubusercontent.com/maoxiang2020/KVideo-config/main/KVideo-config.json'
  }
};
